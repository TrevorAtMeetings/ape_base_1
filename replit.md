...
- August 05, 2025: **NPSHr Chart Display Decision** - removed monotonic smoothing to display raw test data exactly as stored in database, preserving authentic test measurements including non-monotonic behavior (e.g., 134mm impeller showing 3.05m dropping to 2.74m), cubic spline interpolation still applied for smooth curves between test points
