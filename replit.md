...
- July 30, 2025: **Admin database issues resolved** - fixed missing pump name for 18XHC - 3 Stage pump, added missing diameter/speed data for 6 KL and 8 KL pumps, verified 770 zero-flow points are valid shutoff head conditions (not data errors), confirmed all 386 pumps now have complete metadata coverage, admin console endpoints fully functional
